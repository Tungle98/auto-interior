...
@section('title', isset($query) ? 'Chỉnh sửa slider' : 'Tạo slider')
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card mb-4">
                        <h5 class="card-header"> {{ isset($query) ? 'Chỉnh sửa slider' : 'Tạo slider' }}</h5>
                        <div class="card-body">
                            <form class="row g-3 needs-validation" novalidate
                                  @if(isset($query))
                                  action="{{ route('cms.slider.update', $query->id) }}"
                                  @else
                                  action="{{ route('cms.slider.store') }}"
                                  @endif
                                  method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
                                    <label for="exampleFormControlInput1" class="form-label">Tiêu đề slider</label>
