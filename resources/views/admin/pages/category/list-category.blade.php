                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="modalCenterTitle">Tạo danh mục mới</h5>
                                    <button
                                        type="button"
                                        class="btn-close"
                                ...
                                <div class="modal-body">
                                    <form method="POST" action="{{route('cms.category.store')}}" id="formData">
                                        @csrf
        ...
        $(function () {
            ...
            $('body').on('click', '.deleteProperty', function () {
                ...
                if (confirm("Bạn có chắc chắn muốn xóa bản ghi này !") == true) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "{{ url('cms/category/delete') }}" + '/' + data_id,
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                        },
            ...
            $('body').on('click', '.editProperty', function () {
                ...
                $.get("{{ route('cms.category.index') }}" + '/' + property_id + '/edit', function (data) {
